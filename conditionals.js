...
if( item == 'jacket' ){
    console.log("You bought a jacket. " + "Now your current balance is " + (money-40) + " and your health is " + (health + 20) + ".")
} else if ( item == 'candy'){ console.log("You bought candy." + " Now your current balance is " + (money-10) + ".")
}
else if( item == 'paint'){
    console.log(" You bought paint." + " Now your current balance is " + (money -30) + ".")
} else if ( item == 'hammer'){
    console.log("You bought a hammer. " + "Now your current balance is " + (money-70) + ".")
}else {console.log("You bought nothing . ")}; 
